<?php
/* Smarty version 3.1.39, created on 2021-09-30 15:01:58
  from 'C:\wamp64\www\projet_4IRC_acupuncter\templates\nav.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_6155d166980111_33212283',
...
function content_6155d166980111_33212283 (Smarty_Internal_Template $_smarty_tpl) {
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            <ul class="navbar-nav me-auto">
                ...
                <?php if ((isset($_SESSION['id_user']))) {?>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?action=listepatho">Rechercher</a>
                    </li>
                <?php } else { ?>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?action=getlogin">Rechercher</a>
                    </li>
                <?php }?>
            </ul>
            <form class="d-flex">
